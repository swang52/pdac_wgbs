# Description
# Makes HOMER enrichment graphs for all DMR sets
...
HOMER <- function(type = c("TM", "MPN", "EL", "NT", "sub"), top = top){
  ...
  ggplot2::ggplot(ggplot2::aes(x = reorder(Motif, -logP), y = -logP)) +  
...
ggsave(plot_grid(NTplot, ELplot, ncol=1, align="v"), width = 1.7, height = 8.5, file = "HOMER/NTEL_HOMER.pdf")
